...
from models import OfflineItemSimilarity, OnlineItemSimilarity

from torch.utils.data import DataLoader, RandomSampler, SequentialSampler
from models import TAHM
...
def main():
    ...
    parser.add_argument('--augment_type_for_short', type=str, default='SIDC',
    ...
    parser.add_argument("--downsample_rate", type=float, default=0.6, help="insert ratio for insert operator")
    parser.add_argument("--base_warping_factor", type=float, default=1.0, help="insert ratio for insert operator")
    parser.add_argument("--range_width", type=float, default=0.5, help="insert ratio for insert operator")
    ...
    # model args
    parser.add_argument("--model_name", default='TAHM', type=str)
    ...
    parser.add_argument("--rec_weight", type=float, default=1.0, help="weight of cross_entropy task")
    # learning related
    parser.add_argument("--weight_decay", type=float, default=1e-6, help="weight_decay of adam")
    parser.add_argument("--adam_beta1", type=float, default=0.9, help="adam first beta value")
    parser.add_argument("--adam_beta2", type=float, default=0.999, help="adam second beta value")
    # 添加时间分桶参数
    parser.add_argument('--time_buckets', type=int, default=1000,
                        help="Number of buckets for time embedding")
    parser.add_argument('--time_interval_a', type=float, default=200.0,
                        help="时间间隔变换参数a")
    parser.add_argument('--time_interval_c', type=float, default=60000.0,
                        help="时间间隔变换参数c")
    parser.add_argument('--time_interval_max', type=int, default=5000,
                        help="时间间隔嵌入层大小")
    ...
    cluster_dataset = RecWithContrastiveLearningDataset(
        args, user_seq[: int(len(user_seq) * args.training_data_ratio)], time_seq,data_type="train"
    )
    ...
    trainer = CoSeRecTrainer(model, train_dataloader, cluster_dataloader, eval_dataloader,
